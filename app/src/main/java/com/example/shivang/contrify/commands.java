 ...
 * {@link commands.OnFragmentInteractionListener} interface
...
public class commands extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainview = inflater.inflate(R.layout.fragment_commands, container, false);
        listeners();
        return mainview;
    }
    ...
    private void butpref(int pref)
    {
        ...
        if (pref==1)
        {
            nt.execute("3",universals.uname,"1");
        }
        else if (pref==2)
        {
            nt.execute("3",universals.uname,"2");
        }
        else if (pref==3)
        {
            nt.execute("3",universals.uname,"3");
        }
    ...
    public void retcall(String inp)
    {
        ...
        else
        {
            ...
            if (inp.equals("1"))
            {
                ...
                adb.setMessage("Command sent to client.");
                adb.show();
            ...
            {
                adb.setTitle("FAILED");
                adb.setMessage("Command cannot be sent to the client");
                adb.show();
    ...
    {
        Button bt = mainview.findViewById(R.id.shutdown);
        ...
        Button bt2 = mainview.findViewById(R.id.restart);
        ...
        Button bt3 = mainview.findViewById(R.id.sleep);
